...
public class MyGenerator {
    // 基础信息：项目名、作者、版本
    public static final String PROJECT = "memall";
    public static final String AUTHOR = "PeiBo";
    public static final String VERSION = "V1.0";
    // 数据库连接信息：连接URL、用户名、秘密、数据库名
    public static final String URL = "jdbc:mysql://127.0.0.1:3306/memall?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=UTC";
    public static final String NAME = "root";
    public static final String PASS = "root";
    public static final String DATABASE = "memall";
    // 类信息：类名、对象名（一般是【类名】的首字母小些）、类说明、时间
    public static final String CLASSNAME = "CollectionRoute";
    public static final String TABLE = "commodity";
    public static final String CLASSCOMMENT = "资金归集";
    public static final String TIME = "2019年6月12日";
    public static final String AGILE = new Date().getTime() + "";
    // 路径信息，分开路径方便聚合工程项目，微服务项目
    public static final String ENTITY_URL = "com.example.memallapi.entity";
    public static final String DAO_URL = "com.example.memallapi.dao";
    public static final String XML_URL = "com.example.memallapi.dao.impl";
    public static final String SERVICE_URL = "com.example.memallapi.service";
    public static final String SERVICE_IMPL_URL = "com.example.memallapi.service.impl";
    public static final String CONTROLLER_URL = "com.example.memallapi.web";
    //是否是Swagger配置
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String fileUrl = "D:\\javaproject\\memallapi\\src\\main\\java\\com\\example\\memallapi\\";// 生成文件存放位置
            //开始生成文件
